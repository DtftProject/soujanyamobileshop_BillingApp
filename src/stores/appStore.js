...
export const useAppStore = defineStore("appStore", () => {
  ...
  const appUrl = ref(
    getValueFromStorage(APP_URL, "http://crm.soujanya360.com/")
  );
    ...
    if (appUrl.value != "") {
      axiosAdmin()
        ...
        .then(function (response) {
          ...
          updateEmailVerifiedSetting(response.data.email_setting_verified);
      ...
      axiosAdmin()
        ...
        .then(function (response) {
          ...
          if (
            ...
            updateSelectedLang(selectedLang.value, instance, locale);
          }
        })
        .catch(function (error) {});
    }
