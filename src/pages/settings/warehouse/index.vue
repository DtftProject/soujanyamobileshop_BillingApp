<template>
    <f7-page
        ...
        @infinite="fetch"
    >
        <f7-navbar :title="$t('menu.warehouses')" :back-link="$t('common.back')">
            <f7-searchbar
                :custom-search="true"
                ...
                >
                    ...
                    >
                        ...
                        <f7-swipeout-actions right>
                            <f7-swipeout-button
                                v-if="
                                    permsArray.includes('wareshouses_edit') ||
                                    permsArray.includes('admin')
                                "
                            ...
                            <f7-swipeout-button
                                v-if="
                                    (permsArray.includes('wareshouses_delete') ||
                                        permsArray.includes('admin')) &&
                                    appSetting.x_warehouse_id != item.xid
                                "
                                delete
