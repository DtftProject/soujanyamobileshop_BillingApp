<template>
    <f7-page
        ...
        @infinite="fetch"
    >
        <f7-navbar :title="$t('menu.payment_in')" :back-link="$t('common.back')">
            <f7-searchbar
                :custom-search="true"
            ...
            <f7-nav-right>
                ...
                <f7-link
                    ...
                    icon-md="f7:plus"
                    v-if="
                        permsArray.includes('payment_in_create') ||
                ...
                <f7-list media-list>
                    ...
                    >
                        ...
                        <f7-swipeout-actions right>
                            ...
                            <f7-swipeout-button
                                v-if="
                                    permsArray.includes('payment_in_edit') ||
                                    permsArray.includes('admin')
                                "
                                @click="
                                    editItem({
                            ...
                            <f7-swipeout-button
                                v-if="
                                    (permsArray.includes('payment_in_delete') ||
                                        permsArray.includes('admin')) &&
