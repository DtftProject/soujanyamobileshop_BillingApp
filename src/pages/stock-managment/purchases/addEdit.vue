<template>
    <f7-page name="customer-add-edit" @page:beforeunmount="beforeEnter">
        ...
        <f7-list strong-ios dividers-ios outline-ios :style="{ marginTop: '0px' }">
            ...
            <f7-list-input
                type="text"
                :placeholder="$t('common.placeholder_default_text', [$t('user.name')])"
                error-message-force
            ...
            <f7-list-input
                type="email"
                :placeholder="$t('common.placeholder_default_text', [$t('user.email')])"
                error-message-force
            ...
            <f7-list-input
                ...
                "
                error-message-force
                :error-message="rules.tax_number ? rules.tax_number.message : null"
            ...
            >
                <template #input>
                    <div style="display: flex">
                        <span class="input-prefix">{{ appSetting.currency.symbol }}</span>
                        <f7-input
                            type="number"
                            :placeholder="
            ...
            <f7-list-input
                ...
                :input="false"
                error-message-force
                :error-message="rules.credit_period ? rules.credit_period.message : null"
            >
                <template #input>
                    <div style="display: flex">
                        <f7-input
            ...
            <f7-list-input
                ...
                :input="false"
                error-message-force
                :error-message="rules.credit_limit ? rules.credit_limit.message : null"
            >
                <template #input>
                    <div style="display: flex">
                        <span class="input-prefix">{{ appSetting.currency.symbol }}</span>
            ...
            <f7-list-input
                type="textarea"
                :placeholder="
                    $t('common.placeholder_default_text', [$t('user.billing_address')])
                "
                error-message-force
            ...
            <f7-list-input
                type="textarea"
                :placeholder="
                    $t('common.placeholder_default_text', [$t('user.shipping_address')])
                "
                error-message-force
                :error-message="
