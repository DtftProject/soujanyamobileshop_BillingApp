            ...
            <f7-card-content :padding="false">
                ...
                >
                    ...
                    <f7-list-input
                        :input="false"
                        error-message-force
                        :error-message="rules.parent_id ? rules.parent_id.message : null"
                    >
                        <template #label>
                        ...
                        <template #input :style="{ padding: '0px', margin: '0px' }">
                            <CodrajSelect
                                ...
                                @changed="(newVal) => (formData.parent_id = newVal)"
                            />
                        </template>
                    </f7-list-input>
                    ...
                    <f7-list-input
                        type="text"
                        :placeholder="
                            $t('common.placeholder_default_text', [$t('category.name')])
                        "
                        error-message-force
                    ...
                    <f7-list-input
                        type="text"
                        :placeholder="
                            $t('common.placeholder_default_text', [$t('category.slug')])
                        "
                        error-message-force
