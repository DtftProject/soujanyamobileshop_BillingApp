        ...
        >
          <div class="pl-16 pr-16 pt-16 margin-b16 wallet-card-section">
            <div class="wallet-card">
              ...
              >
                {{
                  responseData.stateData && responseData.stateData.totalSales
              ...
              <div class="wallet-footer">
                <div class="grid grid-cols-4 gap-8 mb-8">
                  ...
                  >
                    ...
                    >
                      <div class="icon-wrapper">
                        <f7-icon f7="gift" size="28px" color="white" />
                      </div>
                  ...
                  >
                    ...
                    >
                      <div class="icon-wrapper">
                        <f7-icon f7="wallet" size="28px" color="white" />
                      </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <strong
                        v-html="
                          $t('menu.stock_adjustment').replace(/\s+/g, '<br />')
                        "
                      ></strong>
                    </a>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <strong
                        v-html="
                          $t('menu.stock_summary').replace(/\s+/g, '<br />')
                        "
                      ></strong>
                    </a>
                  </div>
              ...
              >
                ...
                >
                  ...
                  <template #after>
                    {{
                      responseData.stockHistoryStatsData &&
                      responseData.stockHistoryStatsData.totalSalesReturn
                        ? formatQuantity(
                            responseData.stockHistoryStatsData.totalSalesReturn
                          )
                        : formatQuantity(0)
                ...
                >
                  ...
                  <template #after>
                    {{
                      responseData.stockHistoryStatsData &&
                      responseData.stockHistoryStatsData.totalPurchases
                        ? formatQuantity(
                            responseData.stockHistoryStatsData.totalPurchases
                          )
                        : formatQuantity(0)
                ...
                >
                  ...
                  <template #after>
                    {{
                      responseData.stockHistoryStatsData &&
                      responseData.stockHistoryStatsData.totalPurchaseReturn
                        ? formatQuantity(
                            responseData.stockHistoryStatsData
                              .totalPurchaseReturn
                          )
            ...
            <f7-card>
              <f7-card-content :padding="false">
                <f7-list media-list dividers-ios strong-ios>
                  ...
                  <f7-list-item link="/profile/" :title="$t('menu.profile')">
                    <template #media>
                      <f7-icon
                        f7="person_circle"
                        size="24px"
